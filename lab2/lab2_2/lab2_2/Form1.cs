...
namespace lab2_2
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            int nr1 = 2135234;
            int nr2 = 546;
            byte[] nrMare1 = { 7, 7, 7, 6, 7, 6, 7, 7, 2, 7, 7, 7, 1, 0, 2, 3, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 5, 3, 7, 6, 7};
            ...
            BigInteger bigInteger = new BigInteger(nrMare1);
            this.Text = bigInteger.ToString();
            BigInteger bigInteger2 = new BigInteger(nrMare2);
